...
// Mark this cell as being visited on grid array value (false =not visited, true = visited)
...
if(nextRow < 0 || nextRow >= cellsVertical || nextColumn < 0 || nextColumn >= cellsHorizontal) {
    continue;
    // continue skips the rest of the code for this iteration of the for loop and goes to the next neighbor
}
